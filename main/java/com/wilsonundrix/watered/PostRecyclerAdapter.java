...
public class PostRecyclerAdapter extends RecyclerView.Adapter<PostRecyclerAdapter.MyViewHolder> {
    ...
    PostRecyclerAdapter(List<IdeaPosts> postsList) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final String other_user_id = postsList.get(position).getUser_id();


        holder.rlFirst.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Toast.makeText(context, "You clicked for " + post_id, Toast.LENGTH_SHORT).show();

                if (!cur_user.equals(other_user_id)) {
...
//                    Toast.makeText(context,"SAME",Toast.LENGTH_SHORT).show();
                    ...
                    appCompatActivity.getSupportFragmentManager().beginTransaction()
                            .replace(R.id.fl_fragment_content, accountFragment).commit();
...
//        holder.timestampView.setText(new SimpleDateFormat("MMM dd,yyyy HH:mm")
//                .format(new Date(idea.getTimestamp().getTime())));
